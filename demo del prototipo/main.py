...
# GPS NEO-6M - descomentar cuando tengan el fisico
# gps = UART(0, baudrate=9600, tx=Pin(0), rx=Pin(1))

# trama NMEA simulada (reemplaza al GPS fisico por ahora)
GPS_SIMULADO = "$GPRMC,201530.00,A,1202.784,S,07702.568,W,0.0,0.0,170626,,,A*68"
MODO_SIMULADO = True  # cambiar a False cuando tengan el GPS fisico
